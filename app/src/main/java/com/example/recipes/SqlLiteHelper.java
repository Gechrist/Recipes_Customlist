...
public class SqlLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_URL= "image";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        values.put(COLUMN_TITLE, "Oρτύκια κρασάτα");
        values.put(COLUMN_DESC, "Κόβουμε τα ορτύκια με ψαλίδι κουζίνας, κατά μήκος της σπονδυλικής στήλης. Αφαιρούμε τη σπονδυλική στήλη. +\n" +
        ...
        values.put(COLUMN_URL, "https://www.supersyntages.gr/sites/default/files/styles/850x500/public/syntagi-gia-keftedakia-supersyntages.jpg");
        db.insert(TABLE_RECIPES, null, values);

        values = new ContentValues();
        values.put(COLUMN_TITLE, "Γλυκό ψυγείου με μελισσούλες");
        values.put(COLUMN_DESC, "Για τη βάση+\n" +
                "                \"\\n\" +\n" +
                ...
                "                \"Σερβίρουμε.");
        values.put(COLUMN_URL, "https://www.supersyntages.gr/sites/default/files/styles/850x500/public/keik-sokolatas-supersyntages.jpg");
        db.insert(TABLE_RECIPES, null, values);

        values = new ContentValues();
        values.put(COLUMN_TITLE, "Χοιρινές μπριζόλες με γλυκοπατάτες");
        values.put(COLUMN_DESC, "Προθερμαίνουμε τον φούρνο στους 170°C, στον αέρα.\\n\" +\n" +
                ...
                "                \"Ψήνουμε στον προθερμασμένο φούρνο για 40 λεπτά.");
        values.put(COLUMN_URL, "https://www.supersyntages.gr/sites/default/files/styles/850x500/public/syntagi-gia-patatosoyfle-supersyntages-905x540.jpg");
        db.insert(TABLE_RECIPES, null, values);
